function [er, flag] = GalliumPhosphideComplexPermittivity(f)

% G.E. Jellison Jr. Optical functions of GaAs, GaP, and Ge determined by
% two-channel polarization modulation ellipsometry, Opt. Mat. 1, 151-160 (1992)
