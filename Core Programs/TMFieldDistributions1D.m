...
%-----------------------------------------------------------------------y=0
xpoints = round(PPWL*(dmax-dmin)/lambda0);
x1      = dmin + (dmax-dmin)*[0:xpoints]/xpoints;
xo1     = x1;
...
Hzx1 =  H1z2.*(r2<=a) + H2z2.*(r2>a).*(r2<b) + H0z2.*(r2>=b);

clear('x2', 'x2', 'r2', 'phi2', 'r3', 'phi3', 'n3',...
    'C13', 'C23', 'D23', 'C03', 'Q3');

%-----------------------------------------------------------------------x=0
ypoints = round(PPWL*(dmax-dmin)/lambda0);
y1      = dmin + (dmax-dmin)*[0:ypoints]/ypoints;
yo1     = y1;
...
Hzy1 =  H1z2.*(r2<=a) + H2z2.*(r2>a).*(r2<b) + H0z2.*(r2>=b);
